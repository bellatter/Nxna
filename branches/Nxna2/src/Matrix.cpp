...
namespace Nxna
{
	...
	void Matrix::CreateConstrainedBillboard(const Vector3& objectPosition, const Vector3& cameraPosition, const Vector3& rotationAxis, const Vector3* cameraForwardVector, const Vector3* objectForwardVector, Matrix& result)
	{
		float num;
		Vector3 vector;
		Vector3 vector2;
		...
		{
			Vector3::Multiply(vector2, (float)(1.0f / (sqrtf(num2))), vector2);
		}
